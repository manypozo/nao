...
ALTER TABLE "context_recommendation" ADD CONSTRAINT "context_recommendation_run_fk" FOREIGN KEY ("run_id","project_id") REFERENCES "public"."context_recommendation_run"("id","project_id") ON DELETE no action ON UPDATE no action;